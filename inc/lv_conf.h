...
/**
 * lv_conf.h - LVGL Configuration File for Raspberry Pi Pico
 * ILI9341 (SPI) Display + XPT2046 Touch Controller
 */
...
#define LV_USE_PERF_MONITOR    0  /* Set to 1 to enable performance monitor widget */
#define LV_USE_LOG             0  /* Enable debugging log */

/*====================
   DISPLAY SETTINGS
 ====================*/

#define LV_HOR_RES_MAX    240  /* ILI9341 horizontal resolution */
#define LV_VER_RES_MAX    320  /* ILI9341 vertical resolution */

#define LV_COLOR_DEPTH    16   /* 16-bit (RGB565) color depth, required for ILI9341 */
#define LV_COLOR_16_SWAP  1    /* Swap the 16-bit color bytes for correct rendering */

#define LV_DISP_DEF_REFR_PERIOD  30  /* Refresh rate (ms), lower values update faster */

/*====================
   MEMORY MANAGEMENT
 ====================*/

#define LV_MEM_SIZE    (32 * 1024)  /* 32KB for LVGL's internal memory */
#define LV_MEM_CUSTOM  0  /* Use LVGL's internal memory management */
...
#define LV_INDEV_DEF_READ_PERIOD  10  /* Touchscreen read period (ms) */

/* Enable touchscreen (XPT2046) */
#define LV_USE_XPT2046  1
#define LV_XPT2046_HOR_RES  240
#define LV_XPT2046_VER_RES  320

/*====================
   GRAPHICAL OBJECTS
 ====================*/

#define LV_USE_LABEL  1  /* Enable labels (text objects) */
#define LV_USE_BTN    1  /* Enable buttons */
#define LV_USE_IMG    1  /* Enable images */
#define LV_USE_SLIDER 1  /* Enable sliders */
#define LV_USE_CHECKBOX 1 /* Enable checkboxes */
#define LV_USE_MSGBOX 1  /* Enable message boxes */
#define LV_USE_SPINNER 1 /* Enable loading spinners */

/*====================
   FONT CONFIGURATION
 ====================*/

#define LV_FONT_MONTSERRAT_12  1  /* Default font */
#define LV_FONT_DEFAULT  &lv_font_montserrat_12  /* Set default font */
